...
class packer(object):
  ...
  def build(self, input_files, output_file, packaging_module, include_version=True, src_prefix_path=""):
    ...
    if packaging_module == "jsmin":
      ...
      outfile.write("function initX3dom(){")
      outfile.write(out_stream.getvalue())
      outfile.write("x3dom.defineClass=defineClass;return x3dom;} var x3dom=initX3dom();module.exports = x3dom;")
      outfile.close()
    ...
    # NONE
      ...
      outfile.write("return x3dom;} var x3dom = initX3dom(); module.exports = x3dom;")
      outfile.close()
